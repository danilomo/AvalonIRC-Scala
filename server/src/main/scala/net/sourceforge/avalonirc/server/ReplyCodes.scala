...
object ReplyCodes {
  ...
  val RPL_CREATED = "003"
  val RPL_MYINFO = "004"
  val RPL_ISUPPORT = "005"
  val RPL_BOUNCE = "010"
  val RPL_MAP = "015"
  val RPL_MAPEND = "017"
  val RPL_MAPSTART = "018"
  val RPL_HELLO = "020"
  val RPL_YOURID = "042"
  val RPL_SAVENICK = "043"
  ...
  val RPL_LOCALUSERS = "265"
  val RPL_GLOBALUSERS = "266"
  val RPL_NONE = "300"
  val RPL_AWAY = "301"
  ...
  val RPL_NOTOPIC = "331"
  val RPL_TOPIC = "332"
  val RPL_TOPIC_WHO_TIME = "333"
  val RPL_INVITING = "341"
  val RPL_SUMMONING = "342"
  val RPL_REOPLIST = "344"
  val RPL_ENDOFREOPLIST = "345"
  ...
  val ERR_STATSKLINE = "499"
  val ERR_UMODEUNKNOWNFLAG = "501"
  val ERR_USERSDONTMATCH = "502"
  val RPL_ETRACEFULL = "708"
  val RPL_ETRACEEND = "759"
